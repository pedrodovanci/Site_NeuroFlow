...
export default function Home() {
  return (
    <div className="min-h-screen text-white" style={{backgroundColor: 'var(--background)'}}>
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-8">
                ...
                <a href="#how-we-work" className="text-white hover:text-blue-400 transition-colors">Como Trabalhamos</a>
                <a href="#contact" className="text-white hover:text-blue-400 transition-colors">Contato</a>
              </div>
            </div>
            <a href="#contact" className="bg-gradient-to-r from-blue-600 to-blue-800 hover:from-blue-700 hover:to-blue-900 px-6 py-2 rounded-full text-white font-medium transition-all duration-300">
              Começar Agora
            </a>
          </div>
        </div>
      ...
      <section id="home" className="pt-16 min-h-screen flex items-center justify-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto">
            Usamos soluções inteligentes para entregar os melhores resultados para o seu negócio.
          </p>
          
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            <a href="#contact" className="bg-gradient-to-r from-blue-600 to-blue-800 hover:from-blue-700 hover:to-blue-900 px-8 py-4 rounded-full text-white font-medium text-lg transition-all duration-300 transform hover:scale-105">
              Começar Agora
            </a>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            <div className="backdrop-blur-sm border rounded-lg p-6 text-center" style={{backgroundColor: 'var(--card-bg)', borderColor: 'var(--border-color)'}}>
              <div className="w-12 h-12 bg-blue-600/20 rounded-lg flex items-center justify-center mx-auto mb-4">
                ...
                <svg className="w-6 h-6 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 11h16v9H4z M6 7h12l2 4H4l2-4z M11 14h2v6h-2z" />
                </svg>
              </div>
              <h3 className="font-semibold text-white mb-2">Desenvolvimento de e-commerce</h3>
              <p className="text-gray-400 text-sm">Criamos e otimizamos seu e-commerce para aumentar o tráfego e as vendas</p>
            </div>
            ...
            <div className="backdrop-blur-sm border rounded-lg p-6 text-center" style={{backgroundColor: 'var(--card-bg)', borderColor: 'var(--border-color)'}}>
              <div className="w-12 h-12 bg-blue-600/20 rounded-lg flex items-center justify-center mx-auto mb-4">
                ...
                <svg className="w-6 h-6 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 6L3 12l5 6M16 18l5-6-5-6M13 6l-2 12" />
                </svg>
              </div>
              <h3 className="font-semibold text-white mb-2">Construção de agente de IA</h3>
              <p className="text-gray-400 text-sm">Criamos agentes de IA personalizados para suas necessidades</p>
            </div>
            ...
            <div className="backdrop-blur-sm border rounded-lg p-6 text-center" style={{backgroundColor: 'var(--card-bg)', borderColor: 'var(--border-color)'}}>
              <div className="w-12 h-12 bg-blue-600/20 rounded-lg flex items-center justify-center mx-auto mb-4">
                ...
                <svg className="w-6 h-6 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v2 M7 8h10v8H7z M10 12h.01 M14 12h.01 M9 14h6 M6 12h1 M17 12h1" />
                </svg>
              </div>
              <h3 className="font-semibold text-white mb-2">Automação de tarefas</h3>
              <p className="text-gray-400 text-sm">Criamos automações personalizadas para otimizar seus processos</p>
            </div>
            ...
            <div className="backdrop-blur-sm border rounded-lg p-6 text-center" style={{backgroundColor: 'var(--card-bg)', borderColor: 'var(--border-color)'}}>
              <div className="w-12 h-12 bg-blue-600/20 rounded-lg flex items-center justify-center mx-auto mb-4">
                ...
                <svg className="w-6 h-6 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 5h16v14H4zM7 8h2m2 0h2m2 0h2M8 12l2 2-2 2M13 16h4" />
                </svg>
              </div>
              <h3 className="font-semibold text-white mb-2">Solucionamos seus problemas de forma inteligente</h3>
              <p className="text-gray-400 text-sm">Utilizamos a tecnologia mais avançada para fornecer soluções personalizadas para cada desafio</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-300 text-lg leading-relaxed mb-6">
                Na Neuroflow, acreditamos que a tecnologia deve ser acessível, poderosa e intuitiva. 
                Somos uma empresa inovadora dedicada a transformar seus problemas em soluções inteligentes, 
                criando ferramentas que amplificam a capacidade humana.
              </p>
              <p className="text-gray-300 text-lg leading-relaxed mb-6">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Descubra os diferenciais que nos tornam líderes em soluções de Tecnologia
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="backdrop-blur-sm border rounded-xl p-8 text-center hover:transform hover:scale-105 transition-all duration-300" style={{backgroundColor: 'var(--card-bg)', borderColor: 'var(--border-color)'}}>
              ...
              <p className="text-gray-300 leading-relaxed">
                Nossas soluções de Tecnologia processam informações 10x mais rápido que a concorrência, garantindo respostas instantâneas e uma experiência fluida em todas as funcionalidades.
              </p>
            </div>
            ...
            <div className="backdrop-blur-sm border rounded-xl p-8 text-center hover:transform hover:scale-105 transition-all duration-300" style={{backgroundColor: 'var(--card-bg)', borderColor: 'var(--border-color)'}}>
              ...
              <p className="text-gray-300 leading-relaxed">
                Implementamos criptografia de ponta a ponta e protocolos de segurança para proteger 
            ...
            <div className="backdrop-blur-sm border rounded-xl p-8 text-center hover:transform hover:scale-105 transition-all duration-300" style={{backgroundColor: 'var(--card-bg)', borderColor: 'var(--border-color)'}}>
              ...
              <p className="text-gray-300 leading-relaxed">
                Nossa equipe de especialistas oferece suporte personalizado e completo para maximizar seu potencial.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="backdrop-blur-sm border rounded-xl p-8" style={{backgroundColor: 'var(--card-bg)', borderColor: 'var(--border-color)'}}>
              ...
              <p className="text-gray-300 leading-relaxed">
                "A Neuroflow revolucionou nossa empresa. A automação nos ajudou em processos que antes levavam horas."
              </p>
            </div>
            ...
            <div className="backdrop-blur-sm border rounded-xl p-8" style={{backgroundColor: 'var(--card-bg)', borderColor: 'var(--border-color)'}}>
              <div className="flex items-center mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">Analista sênior, InnovaCorp</p>
                </div>
              </div>
              <div className="flex mb-4">
                {[...Array(5)].map((_, i) => (
              ...
              <p className="text-gray-300 leading-relaxed">
                "Como desenvolvedor, fiquei impressionado com a qualidade das ferramentas utilizadas pela Neuroflow. Aumentou nossa produtividade em 300%."
              </p>
            </div>
            ...
            <div className="backdrop-blur-sm border rounded-xl p-8" style={{backgroundColor: 'var(--card-bg)', borderColor: 'var(--border-color)'}}>
              ...
              <p className="text-gray-300 leading-relaxed">
                "A interface é super intuitiva. Mesmo sem conhecimento técnico, consegui implementar 
                soluções complexas rapidamente."
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="space-y-8">
              <div className="backdrop-blur-sm border rounded-xl p-6" style={{backgroundColor: 'var(--card-bg)', borderColor: 'var(--border-color)'}}>
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-white mb-2">Análise e Planejamento</h3>
                    <p className="text-gray-300">Entendemos suas necessidades e definimos a melhor estratégia para seu projeto.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="backdrop-blur-sm border rounded-xl p-6" style={{backgroundColor: 'var(--card-bg)', borderColor: 'var(--border-color)'}}>
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">Implementamos soluções usando as tecnologias mais avançadas e práticas recomendadas.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="backdrop-blur-sm border rounded-xl p-6" style={{backgroundColor: 'var(--card-bg)', borderColor: 'var(--border-color)'}}>
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-white mb-2">Testes e Otimização</h3>
                    <p className="text-gray-300">Garantimos qualidade através de testes rigorosos e otimizações contínuas.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="backdrop-blur-sm border rounded-xl p-6" style={{backgroundColor: 'var(--card-bg)', borderColor: 'var(--border-color)'}}>
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">Entregamos o projeto finalizado com suporte contínuo para garantir seu sucesso.</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section id="contato" style={{backgroundColor: 'rgba(26, 35, 50, 0.3)'}} className="py-20 scroll-mt-24">
      ...
      <footer style={{backgroundColor: 'var(--card-bg)', borderColor: 'var(--border-color)'}} className="border-t py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              <h4 className="font-bold text-white mb-4">Nos siga nas redes sociais</h4>
              <ul className="space-y-2">
                <li>
                  <a href="https://www.instagram.com/neuroflowtecnologia" target="_blank" rel="noopener noreferrer" className="inline-flex items-center space-x-2 text-gray-300 hover:text-pink-400 transition-colors">
